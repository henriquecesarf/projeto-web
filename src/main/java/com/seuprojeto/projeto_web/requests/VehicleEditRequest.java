...
public class VehicleEditRequest {
    ...
    public VehicleEditRequest() {
    }

    public VehicleEditRequest(String name, String manufacturer, String version, String urlFipe, String color, Exchange exchange, Double km, Integer capacityPassengers, Integer volumeLoad, Boolean available, List<String> accessories, Double valuedaily, Long categoryId) {
        this.name = name;
